      ...
      <div className={styles.cards}>
        <div className={styles.card__left}>
          ...
          <p className={styles.card__description}>
            Build responsive websites and web apps with React, Next.js,
            TypeScript, and more. Emphasis on security and user-centered
            solutions.
          </p>
        </div>
        <div className={styles.card__right}>
          ...
          <p className={styles.card__description}>
            Ensure application protection from cyber threats with our expertise
            in security testing.
          </p>
        </div>
        <div className={styles.card__left}>
          ...
          <p className={styles.card__description}>
            Tailored solutions for web and mobile apps, from prototyping to
